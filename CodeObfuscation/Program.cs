...
namespace CodeObfuscation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Priority.En_Priority[] priorityTable = { Priority.En_Priority.COMMENT, Priority.En_Priority.CLASS, Priority.En_Priority.CONSTRUCTOR, Priority.En_Priority.METHOD, Priority.En_Priority.VARIABLE, Priority.En_Priority.OCCURENCE, Priority.En_Priority.TYPE_INFERENCE, Priority.En_Priority.ENUM/*Priority.En_Priority.PARAMETER*/ };
