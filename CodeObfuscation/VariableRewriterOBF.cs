...
{
    class MQVUvuuquqxypEbMoCadHndcspypyPmNzjgMEdUIBOFPMkzavPvJUELOuwaMAbxOquslQsIviwazzUpxjxdN: CSharpSyntaxRewriter
    {
        public MQVUvuuquqxypEbMoCadHndcspypyPmNzjgMEdUIBOFPMkzavPvJUELOuwaMAbxOquslQsIviwazzUpxjxdN() { }
        ...
        public override SyntaxNode VisitVariableDeclarator(VariableDeclaratorSyntax node)
        {
            ...
            else
            {
                ...
                KkvPTJdFdQdlTfiyyOzuBekNLAwCjzUhxGMFhnxFzSbbsXPeaGNoPuwpApET.Instance.iddBEXbvOSqBTzlbUGAPhiQwMvvFnMLPEfnVQRoQFFsUnathlMhLrpJAULhHrknCH[GGCIqshKdvxwqRdqUKagLTwgCOLhnoFiweTXwFCupvzqsCrgywQypyIduOFJXAMDjNAnnNnO] = GKqFtTINKPrntpRJhRBwOSCQbQLMRRdRvsdBlyTtvNMAgPeMDGwLmlpfHIILHcvztJClvQRJnWyAGCtojnIKlwSDBnzaVI.En_Priority.VARIABLE;
            ...
            VariableDeclaratorSyntax kAkDIWejczhtexQoUEKJxnFbdUKToFPoRHkRxnLmntCDwvhbUGjXfVizxxQfMHHjrHLSDmgVlKKQvBVjuN= node.WithIdentifier(Identifier(ulJsfVDJxNPmsKuJOtCMEXlAxqhXUJOKkcVnQUWQPkLTqPXlMHazhBtGmIjMouhsnEIhhilzGdbNMXwt)).WithLeadingTrivia(node.GetLeadingTrivia()).WithTrailingTrivia(node.GetTrailingTrivia());
